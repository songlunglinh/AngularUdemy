(function(){
  app.controller( 'IndexCtrl', [ '$scope', '$rootScope', 'employeeFactory', '$alert', function( $scope, $rootScope, employeeFactory, $alert ) {
  ...
  app.controller( 'AddCtrl', [ '$scope', '$rootScope', 'employeeFactory','$alert', function( $scope, $rootScope, employeeFactory, $alert ) {
    var alert = $alert({
      title: 'Success!',
  ...
  app.controller( 'EmployeeCtrl', [ '$scope', '$rootScope', '$routeParams', function( $scope, $rootScope, $routeParams ) {
    ...
    console.log('Show age: '+$scope.user.age);
	} ] );
